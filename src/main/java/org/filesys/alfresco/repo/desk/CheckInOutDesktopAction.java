 ...
 * 
 * <p>Provides check in/out functionality via SMB using the desktop action interface.
 * 
 * @author gkspencer
 */
public class CheckInOutDesktopAction extends DesktopAction {
	...
	public DesktopResponse runAction(final DesktopParams params) {
        ...
        final List<Pair<NotifyAction, String>> fileChanges = new LinkedList<Pair<NotifyAction,String>>();
		            ...
		            if ( nodeService.hasAspect( target.getNode(), ContentModel.ASPECT_WORKING_COPY))
		            {
		                try
		                {
		                    ...
		                    if ( getContext().hasFileServerNotifications()) {
		                        ...
		                        fileChanges.add(new Pair<NotifyAction, String>(NotifyAction.Removed, fileName));
		                    }
		                }
		                catch (Exception ex)
		                {
		            ...
		            else
		            {
		                try
		                {
		                    ...
		                    if ( getContext().hasChangeHandler()) {
		                        ...
		                        fileChanges.add(new Pair<NotifyAction, String>(NotifyAction.Added, fileName));
		                    }
		                }
		                catch (Exception ex)
		                {
	    ...
	    RetryingTransactionCallback<Void> notifyCB = new RetryingTransactionCallback<Void>() {
	        ...
	        public Void execute() throws Throwable
	        {
	            ...
	            for (Pair<NotifyAction, String> fileChange : fileChanges)
	            {
